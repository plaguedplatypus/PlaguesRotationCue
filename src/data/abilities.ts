...
const cooldowns: Record<string, number> = {
  ...
  runic_charge: 30,
  sonic_wave: 15,
  greater_sonic_wave: 15,
  dragon_breath: 7.2,
  impact: 15,
  combust: 18,
  chain: 10.2,
  greater_chain: 10.2,
  concentrated_blast: 5.4,
  greater_concentrated_blast: 5.4,
  wild_magic: 5.4,
  asphyxiate: 20.4,
  smoke_tendrils: 45,
  magma_tempest: 21,
  ...
  split_soul: 60,
  invoke_death: 4,
  conjure_putrid_zombie: 30,
  command_phantom_guardian: 9,
  command_skeleton_warrior: 15,
  dive: 20.4,
  escape: 20.4,
  surge: 20.4,
  anticipation: 24.6,
